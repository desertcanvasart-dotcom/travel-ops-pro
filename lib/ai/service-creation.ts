...
function normalizeAttractionForMatch(name: string): string {
  ...
  const nameMap: Record<string, string> = {
    ...
    'giza pyramids and sphinx': 'Giza Plateau',
    'pyramids of giza and sphinx': 'Giza Plateau',
    ...
    'memphis': 'Memphis',
    'mit rahina': 'Memphis',
    'open museum at mit rahina': 'Memphis',
    'mit rahina open museum': 'Memphis',
  }
