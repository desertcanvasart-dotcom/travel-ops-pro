...
interface TransportVoucherData {
  /**
   * The operator's own name for the voucher header and footer.
   *
   * Passed in rather than read from the environment: this template is rendered
   * from both a route and a page, and a voucher handed to a driver naming the
   * wrong agency is worse than one naming none.
   */
  operatorName?: string
  ...
  <div class="voucher">
    ...
    <div style="background: linear-gradient(135deg, #0d9488 0%, #0f766e 100%); color: white; padding: 24px 32px;">
      <div style="display: flex; justify-content: space-between; align-items: flex-start;">
        <div>
          ${data.operatorName ? `<h1 style="font-size: 24px; font-weight: 700; margin-bottom: 4px;">${data.operatorName.toUpperCase()}</h1>` : ''}
    ...
    <div style="background: #f9fafb; padding: 16px 32px; border-top: 1px solid #e5e7eb;">
      <div style="display: flex; justify-content: space-between; align-items: center;">
        <div style="font-size: 12px; color: #6b7280;">
          ${['Generated by Autoura', data.operatorName && `${data.operatorName} Operations`].filter(Boolean).join(' • ')}
        </div>
        <div style="font-size: 12px; color: #6b7280;">
