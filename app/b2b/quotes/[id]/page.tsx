          ...
          <div className="bg-white rounded-lg border p-6">
            ...
            <div className="grid grid-cols-4 gap-4">
              ...
              <div className="bg-gray-50 rounded-lg p-3">
                ...
                <p className="text-sm font-semibold">{quote.num_adults} pax{quote.tour_leader_included && <span className="text-blue-600"> (+1 TL)</span>}{quote.guide_mode === 'throughout' && <span className="text-[#647C47]"> (Throughout Guide{quote.guide_grade === 'senior' ? ' · Senior' : ''})</span>}{quote.guide_mode !== 'throughout' && quote.guide_grade === 'senior' && <span className="text-[#647C47]"> (Senior guide)</span>}</p>
              </div>
              <div className="bg-gray-50 rounded-lg p-3">
