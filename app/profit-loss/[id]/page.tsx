...
const CATEGORY_CONFIG: Record<string, { label: string; icon: string; color: string }> = {
  ...
  airport_staff: { label: 'Airport Assistant', icon: '✈️', color: 'bg-sky-100 text-sky-700' },
  hotel_staff: { label: 'Hotel Assistant', icon: '🛎️', color: 'bg-violet-100 text-violet-700' },
