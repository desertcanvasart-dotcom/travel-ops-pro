    ...
    <div className="bg-white border border-gray-200 rounded-xl shadow-sm mb-4">
      ...
      <div className="px-4 py-3 flex flex-wrap items-center gap-x-5 gap-y-3">
        ...
        <div className="flex items-center gap-3 border border-gray-100 rounded-lg px-3 py-1.5 bg-gray-50/50">
          ...
          {/* Spot vs Throughout ("+1") — only meaningful with a guide. In
              throughout mode the guide's bed (chosen hotel/cruise row's guide
              rate), his meals for groups of 3 or fewer, and a seat on every
              flight pick are added automatically; the rate sheet sizes
              vehicles at pax+1. Meet/assist days: pick the "Meet & Assist
              day" guide row on those days. */}
          {config.withGuide && (
            <button
              type="button"
