...
export default function ClientProfilePage() {
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex items-center justify-between mb-6">
            ...
            <div className="flex items-center gap-3">
              ...
              <button className="inline-flex items-center gap-2 px-4 py-2 bg-red-100 text-red-700 rounded-lg hover:bg-red-200">
          ...
          <div className="flex items-start justify-between">
            ...
            <div className="grid grid-cols-3 gap-4">
              ...
              <div className="bg-purple-50 rounded-lg p-4 text-center">
                ...
                <div className="text-xs text-gray-600 mt-1">Avg Value</div>
              </div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-3 gap-6">
            ...
            <div className="col-span-2 space-y-6">
              ...
              <div className="bg-white rounded-lg shadow p-6">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    ...
                    <p className="font-medium">{client.preferred_language || 'Not specified'}</p>
                  </div>
                  <div>
                    <label className="text-sm text-gray-600">Passport Type</label>
                    <p className="font-medium">{client.passport_type || 'Not specified'}</p>
                  </div>
                  <div>
                    <label className="text-sm text-gray-600">Preferred Contact</label>
                    <p className="font-medium">{client.preferred_contact_method || 'Not specified'}</p>
                  </div>
                  <div>
              ...
              {client.special_interests && client.special_interests.length > 0 && (
                <div className="bg-white rounded-lg shadow p-6">
                  <h3 className="text-lg font-semibold mb-4">Special Interests</h3>
              ...
              {client.internal_notes && (
                <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-6">
                  ...
                  <p className="text-gray-700">{client.internal_notes}</p>
                </div>
              )}
            </div>
            ...
            <div className="space-y-6">
              ...
              <div className="bg-white rounded-lg shadow p-6">
               ...
               className="w-full flex items-center gap-2 px-4 py-2 bg-blue-50 text-blue-700 rounded-lg hover:bg-blue-100"
                 >
                ...
                <button 
                   ...
                   className="w-full flex items-center gap-2 px-4 py-2 bg-green-50 text-green-700 rounded-lg hover:bg-green-100"
                   >
                  ...
                  Add Follow-up
                   ...
                   className="w-full flex items-center gap-2 px-4 py-2 bg-orange-50 text-orange-700 rounded-lg hover:bg-orange-100"
                     >
              ...
              <div className="bg-white rounded-lg shadow p-6">
                ...
                <div className="space-y-3">
                  ...
                  {communications.length > 0 && (
                    <div className="text-sm">
                      <p className="text-gray-600">Last Communication</p>
                      ...
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          <div className="flex items-center gap-2">
                            <span className="font-semibold capitalize">{comm.communication_type.replace('_', ' ')}</span>
        ...
        {activeTab === 'bookings' && (
          <div>
            <div className="flex justify-between items-center mb-6">
              ...
              <Link
               href={`/whatsapp-parser?clientId=${clientId}`}  // ← Fixed!
               className="inline-flex items-center gap-2 px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700"
               >
              <Plus className="w-4 h-4" />
              New Booking
              ...
              <div className="grid gap-4">
                {bookings.map((booking) => (
                  <div key={booking.id} className="bg-white rounded-lg shadow p-6">
                    <div className="flex items-start justify-between">
                      <div>
                        <h3 className="text-lg font-semibold mb-2">{booking.tour_name}</h3>
  ...
  editCommunication={editingCommunication}  // ← ADD
/>
