...
export async function GET(
  ...
  try {
    ...
    if (error) {
      ...
      return NextResponse.json({ success: false, error: clientMessage(error, 'Failed to load guide rate') }, { status: 500 })
    }
...
export async function PUT(
  ...
  try {
    ...
    if (error) {
      ...
      return NextResponse.json({ success: false, error: clientMessage(error, 'Failed to save guide rate') }, { status: 500 })
    }
...
export async function DELETE(
  ...
  try {
    ...
    if (error) {
      ...
      return NextResponse.json({ success: false, error: clientMessage(error, 'Failed to delete guide rate') }, { status: 500 })
    }
