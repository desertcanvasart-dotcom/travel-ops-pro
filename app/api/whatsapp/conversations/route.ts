...
export async function GET(request: NextRequest) {
  try {
    ...
    return NextResponse.json({ error: clientMessage(error, 'Failed to fetch conversations') }, { status: 500 })
  }
}
...
export async function POST(request: NextRequest) {
  try {
    ...
    return NextResponse.json({ error: clientMessage(error, 'Failed to create conversation') }, { status: 500 })
  }
}
...
export async function PATCH(request: NextRequest) {
  try {
    ...
    return NextResponse.json({ error: clientMessage(error, 'Failed to update conversation') }, { status: 500 })
  }
}
...
export async function DELETE(request: NextRequest) {
  try {
    ...
    return NextResponse.json({ error: clientMessage(error, 'Failed to hide conversation') }, { status: 500 })
  }
}