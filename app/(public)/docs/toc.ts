...
import {
  BarChart, BarChart3, Bell, BellRing, BookOpen, Bot, Briefcase, Building2, Calculator, Calendar, CalendarCheck, CalendarRange, CheckSquare, ClipboardList, ConciergeBell, CreditCard, FileCheck, FileText, FolderOpen, Gauge, GitBranch, Globe, IdCard, Languages, LayoutDashboard, Lightbulb, Link2, MailPlus, Map, MessageCircle, MessagesSquare, Receipt, Rocket, Settings, Sparkles, Tag, TrendingUp, UserRound, Users, Wallet, Wand2,
} from 'lucide-react'
...
export const CATEGORIES: DocCategory[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { href: '/docs/copilot', navLabel: 'AI Copilot', icon: Sparkles, title: 'AI Copilot & Knowledge Base', description: 'Ask questions and draft replies grounded in your own knowledge base (RAG). Agent memory learns your style over time.' },
      ...
      { href: '/docs/clients', navLabel: 'Clients (CRM)', icon: Users, title: 'Clients (CRM)', description: 'Add, search, and manage client profiles, notes, and follow-ups.' },
  ...
  },
  {
    ...
    items: [
      ...
      { href: '/docs/multi-language', navLabel: 'Languages', icon: Languages, title: 'Multi-Language', description: 'Copy and translate itineraries and B2B quotes between English and Japanese with one click.' },
    ],
  },
  {
    label: 'B2B',
